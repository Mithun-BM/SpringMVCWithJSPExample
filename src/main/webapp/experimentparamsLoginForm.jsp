...
<title>SpringMVCHelloWorldJSPExample Experiment params Login Form JSP
	Page</title>
	<style>
    .error {
...
<body>
	<form:form id="postExperimentEmpForm" method="post" action="experimentparams" modelAttribute="employee">
		...
		<input type="hidden" id="employeeCode" name="employeeCode" value="employeeCode"/> <!-- We can either use hidden param or form path attribute as parameter for hitting post -->
		<table align="center">
			<tr>
		...
		<br />
		<input type="submit" value="SUBMIT EMPLOYEE FORM" />
	</form:form>
	<form:form id="postExperimentProjectForm" method="post" action="experimentparams" modelAttribute="project">
		...
		<h3>Experiment Project Login Form</h3>
		<input type="hidden" id="projectCode" name="projectCode" value="projectCode"/> <!-- We can either use hidden param or form path attribute as parameter for hitting post -->
		<table align="center">
			<tr>
		...
		<br />
		<input type="submit" value="SUBMIT PROJECT FORM" />
	</form:form>
</body>
</html>