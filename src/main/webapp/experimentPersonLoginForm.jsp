...
<title>SpringMVCHelloWorldJSPExample Experiment Person Login Form JSP
	Page</title>
<style>
    .error {
...
<body>
	<form:form id="postExperimentPersonForm" method="post" action="personSessionUsageExample" modelAttribute="person">
		...
		<h3>Experiment Person Login Form</h3>
		<table align="center">
			<tr>
