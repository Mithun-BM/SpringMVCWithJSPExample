...
<title>SpringMVCHelloWorldJSPExample Experiment GET Employee Form Data JSP
	Page</title>
</head>
<script src="jquery-2.1.1.min.js"></script>
<!-- Downloaded jquery location -->
<script>
function testmodelAttributeValueInScript(){
	debugger;
	var var1 = '${dummyValue}';/* accessing value from controller in javascript. */
	alert(var1);
}
</script>
<body>
	<form:form id="experimentGetEmpForm" method="get"
		action="experimentGetEmployeeFormData1stWay" modelAttribute="employeeForm" >
	...
	<br />
	<br />
	<input type="button" value="BUTTON" onclick="testmodelAttributeValueInScript()">
</body>
</html>